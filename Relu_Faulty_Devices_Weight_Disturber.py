...
i = 1
relu_accuracy_cols = ["Undistrubed accuracy","Type1 disturbed","Type2 disturbed","Type3 disturbed","Type4 disturbed"]
relu_accuracy = []
...
while i <= 30:
  ...
  relu_type4_model_weights = [disturbed_type4_layer_1_weights,weights[1],disturbed_type4_layer_2_weights,weights[3]]
  ...
  relu_type4_model.set_weights(relu_type4_model_weights)
  ...
  var4 = relu_type4_model.evaluate(
    test_images,
    to_categorical(test_labels)
  )
  relu_type1_filename = "Type1_disturbed/Relu_type1_disturbed_files/Relu_type1_disturbed_model_" + str(i) + ".h5"
  relu_type2_filename = "Type2_disturbed/Relu_type2_disturbed_files/Relu_type2_disturbed_model_" + str(i) + ".h5"
  relu_type3_filename = "Type3_disturbed/Relu_type3_disturbed_files/Relu_type3_disturbed_model_" + str(i) + ".h5"
  relu_type4_filename = "Type4_disturbed/Relu_type4_disturbed_files/Relu_type4_disturbed_model_" + str(i) + ".h5"
  ...
  relu_type4_model.save_weights(relu_type4_filename)

  relu_ith_accuracy = [var[1],var1[1],var2[1],var3[1],var4[1]]
