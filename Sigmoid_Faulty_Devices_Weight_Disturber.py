...
i = 1
sigmoid_accuracy_cols = ["Undistrubed accuracy","Type1 disturbed","Type2 disturbed","Type3 disturbed"]
sigmoid_accuracy = []
...
while i <= 30:
  ...
  sigmoid_type2_filename = "Type2_disturbed/Sigmoid_type2_disturbed_files/Sigmoid_type1_disturbed_model_" + str(i) + ".h5"
  sigmoid_type3_filename = "Type3_disturbed/Sigmoid_type3_disturbed_files/Sigmoid_type1_disturbed_model_" + str(i) + ".h5"
  ...
  sigmoid_ith_accuracy = [var[1],var1[1],var2[1],var3[1]]
