...
i = 1
tanh_accuracy_cols = ["Undistrubed accuracy","Type1 disturbed","Type2 disturbed","Type3 disturbed","Type4 disturbed"]
tanh_accuracy = []
...
while i <= 30:
  ...
  tanh_type4_model_weights = [disturbed_type4_layer_1_weights,weights[1],disturbed_type4_layer_2_weights,weights[3]]
  ...
  tanh_type4_model.set_weights(tanh_type4_model_weights)
  ...
  var4 = tanh_type4_model.evaluate(
    test_images,
    to_categorical(test_labels)
  )
  tanh_type1_filename = "Type1_disturbed/Tanh_type1_disturbed_files/Tanh_type1_disturbed_model_" + str(i) + ".h5"
  tanh_type2_filename = "Type2_disturbed/Tanh_type2_disturbed_files/Tanh_type2_disturbed_model_" + str(i) + ".h5"
  tanh_type3_filename = "Type3_disturbed/Tanh_type3_disturbed_files/Tanh_type3_disturbed_model_" + str(i) + ".h5"
  tanh_type4_filename = "Type4_disturbed/Tanh_type4_disturbed_files/Tanh_type4_disturbed_model_" + str(i) + ".h5"
  ...
  tanh_type4_model.save_weights(tanh_type4_filename)

  tanh_ith_accuracy = [var[1],var1[1],var2[1],var3[1],var4[1]]
